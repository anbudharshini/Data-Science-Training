...
db.sessions.aggregate([
 {$lookup:{from:"trainers",localField:"trainer_id",foreignField:"trainer_id",as:"trainer"}},
 {$unwind:"$trainer"},
...
db.sessions.aggregate([
 {$group:{_id:"$member_id",total_sessions:{$sum:1}}},
 {$lookup:{from:"members",localField:"_id",foreignField:"member_id",as:"member"}},
 {$unwind:"$member"},
 {$project:{_id:0,member:"$member.name",total_sessions:1}}
])
...
db.sessions.aggregate([
 {$group:{_id:"$member_id",unique_trainers:{$addToSet:"$trainer_id"}}},
 {$project:{trainer_count:{$size:"$unique_trainers"}}},
 {$match:{trainer_count:{$gt:1}}},
 {$lookup:{from:"members",localField:"_id",foreignField:"member_id",as:"member"}},
 {$unwind:"$member"},
 {$project:{_id:0,member:"$member.name",trainer_count:1}}
])

// Advanced Queries
// 11. Display sessions with member name and trainer name
db.sessions.aggregate([
 {$lookup:{from:"members",localField:"member_id",foreignField:"member_id",as:"member"}},
 {$lookup:{from:"trainers",localField:"trainer_id",foreignField:"trainer_id",as:"trainer"}},
 {$unwind:"$member"},
 {$unwind:"$trainer"},
 {$project:{_id:0,session_id:1,member:"$member.name",trainer:"$trainer.name",session_type:1,duration:1,date:1}}
])

// 12. Calculate total session time per trainer
db.sessions.aggregate([
 {$group:{_id:"$trainer_id",total_time:{$sum:"$duration"}}},
 {$lookup:{from:"trainers",localField:"_id",foreignField:"trainer_id",as:"trainer"}},
 {$unwind:"$trainer"},
 {$project:{_id:0,trainer:"$trainer.name",total_time:1}}
])
...
db.sessions.aggregate([
 ...
 {$lookup:{from:"members",localField:"_id",foreignField:"member_id",as:"member"}},
 {$unwind:"$member"},
 {$project:{_id:0,member:"$member.name",total_time:1}}
])

// 14. Count how many sessions each trainer has conducted
db.sessions.aggregate([
 {$group:{_id:"$trainer_id",total_sessions:{$sum:1}}},
 {$lookup:{from:"trainers",localField:"_id",foreignField:"trainer_id",as:"trainer"}},
 {$unwind:"$trainer"},
 {$project:{_id:0,trainer:"$trainer.name",total_sessions:1}}
])
...
db.sessions.aggregate([
 ...
 {$lookup:{from:"trainers",localField:"_id",foreignField:"trainer_id",as:"trainer"}},
 {$unwind:"$trainer"},
 {$project:{_id:0,trainer:"$trainer.name",avg_duration:1}}
])

// 16. Show how many unique members each trainer has trained
db.sessions.aggregate([
 {$group:{_id:"$trainer_id",unique_members:{$addToSet:"$member_id"}}},
 {$project:{trainer_id:"$_id",unique_members_count:{$size:"$unique_members"}}},
 {$lookup:{from:"trainers",localField:"trainer_id",foreignField:"trainer_id",as:"trainer"}},
 {$unwind:"$trainer"},
 {$project:{_id:0,trainer:"$trainer.name",unique_members_count:1}}
])
...
db.sessions.aggregate([
 ...
 {$lookup:{from:"members",localField:"_id",foreignField:"member_id",as:"member"}},
 {$unwind:"$member"},
 {$project:{_id:0,member:"$member.name",total_duration:1}}
])
...
db.sessions.aggregate([
 {$lookup:{from:"members",localField:"member_id",foreignField:"member_id",as:"member"}},
 {$unwind:"$member"},
 {$group:{_id:"$member.membership_type",total_sessions:{$sum:1}}}
])

// 20. Find members who have not attended any session yet
db.members.aggregate([
 {$lookup:{from:"sessions",localField:"member_id",foreignField:"member_id",as:"session_info"}},
 {$match:{session_info:{$size:0}}}
])
